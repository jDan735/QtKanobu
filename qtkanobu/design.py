...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/main/img/main/cut.hvif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/main/img/main/ruby.hvif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/main/img/main/qt"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAbout_Qt.setIcon(icon3)
        self.actionAbout_Qt.setObjectName("actionAbout_Qt")
        self.actionAbout_QtKanobu = QtWidgets.QAction(MainWindow)
        self.actionAbout_QtKanobu.setIcon(icon)
